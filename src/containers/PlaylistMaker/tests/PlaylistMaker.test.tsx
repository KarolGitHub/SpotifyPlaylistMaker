      ...
      act(() => {
        ...
        const asyncCheck = setImmediate(() => {
          ...
          expect(store.getState()).toContainEqual({
            ...
            loading: false,
            authRedirectPath:
              "https://accounts.spotify.com/authorize?client_id=4ab35e6f4e00492f9af5a2358e409f9f&redirect_uri=http://localhost:3000/login&scope=playlist-modify-public playlist-modify-private playlist-read-private playlist-read-collaborative&response_type=token&state=123",
          });
        });
        wrapper
          .find(Input)
